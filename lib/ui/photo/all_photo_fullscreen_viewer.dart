...
class AllFotoFullScreenViewer extends StatefulWidget {
  final List<PlacePhoto> photos;
  final int initialIndex;
  final VoidCallback onChanged;

  const AllFotoFullScreenViewer({
    super.key,
  ...
  @override
  State<AllFotoFullScreenViewer> createState() =>
      _AllFotoFullScreenViewerState();
}

class _AllFotoFullScreenViewerState extends State<AllFotoFullScreenViewer> {
