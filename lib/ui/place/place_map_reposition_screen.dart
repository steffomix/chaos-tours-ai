...
class PlaceMapRepositionScreen extends StatefulWidget {
  final SavedPlace targetPlace;

  const PlaceMapRepositionScreen({super.key, required this.targetPlace});

  @override
  State<PlaceMapRepositionScreen> createState() =>
      _PlaceMapRepositionScreenState();
}

class _PlaceMapRepositionScreenState extends State<PlaceMapRepositionScreen> {
