...
enum PlacesFilterSpecificRatingField {
  dangerousFriendly,
  fraudReliable,
  ...
  static PlacesFilterSpecificRatingField? fromDbColumn(String column) {
    for (final f in PlacesFilterSpecificRatingField.values) {
...
class PlacesFilterState {
  ...
  final PlacesFilterSpecificRatingField? specificRatingField;
  ...
  PlacesFilterState copyWith({
    ...
    PlacesFilterSpecificRatingField? specificRatingField,
...
class ExperienceFilterPanel extends StatefulWidget {
  ...
  final ValueChanged<PlacesFilterState> onChanged;
...
class _ExperienceFilterPanelState extends State<ExperienceFilterPanel> {
  ...
  PlacesFilterState get filter => widget.filter;
  ValueChanged<PlacesFilterState> get onChanged => widget.onChanged;
  ...
  Widget _ratingSliderRow(BuildContext context, PlacesFilterState filter) {
  ...
  Widget _avgMedianRadio(BuildContext context, PlacesFilterState filter) {
    final l10n = AppLocalizations.of(context)!;
                        ...
                        onChanged: (v) {
                          if (v) {
                            ...
                            final field =
                                ...
                                PlacesFilterSpecificRatingField.values.first;
                            onChanged(
                              filter.copyWith(
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            child:
                                DropdownButton<PlacesFilterSpecificRatingField>(
                                  value:
                                      filter.specificRatingField ??
                                      PlacesFilterSpecificRatingField
                                          .values
                                          .first,
                                  isExpanded: true,
                                  onChanged: (v) {
                                  ...
                                  items: PlacesFilterSpecificRatingField.values
                                      .map(
                                        (f) => DropdownMenuItem(
                                          value: f,
                                          child: Text(
